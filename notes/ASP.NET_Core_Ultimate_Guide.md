...
# 第6章 控制器和操作结果 Controllers & IActionResult
...
![2026-05-25-22-17-48](https://cdn.jsdelivr.net/gh/ankium/mindnotes@assets/bags/2026-05-25-22-17-48.png)

![2026-05-25-22-18-15](https://cdn.jsdelivr.net/gh/ankium/mindnotes@assets/bags/2026-05-25-22-18-15.png)


### 8.1.1 MVC的职责

![2026-05-25-22-22-42](https://cdn.jsdelivr.net/gh/ankium/mindnotes@assets/bags/2026-05-25-22-22-42.png)
...
![2026-05-25-22-38-17](https://cdn.jsdelivr.net/gh/ankium/mindnotes@assets/bags/2026-05-25-22-38-17.png)
...
在ASP.NET Core中，视图是一个负责包含设计逻辑和表示逻辑的网页。

![2026-05-25-22-38-55](https://cdn.jsdelivr.net/gh/ankium/mindnotes@assets/bags/2026-05-25-22-38-55.png)

表示逻辑可以是HTML或C#形式，HTML代码称为客户端代码，C#代码称为服务器端代码。这意味着，在服务器端C#代码执行，视图的结果将作为响应发送到浏览器，然后在客户端浏览器上HTML代码执行。

### 8.2.1 视图的原理

Razor 是 ASP.NET Core 中用于构建网页内容的服务器端视图引擎，它将 C# 代码和 HTML 混合在一起，实现动态网页渲染。它在服务器端编译为 C# 类，执行后返回 HTML 内容给客户端。

![2026-05-25-22-40-30](https://cdn.jsdelivr.net/gh/ankium/mindnotes@assets/bags/2026-05-25-22-40-30.png)

核心思想是：代码即模板，允许在 HTML 文件中嵌入 C# 代码，实现动态内容的生成。

### 8.2.2 视图的保存路径

Razor 视图通常位于项目的 Views 文件夹下，根据控制器路径自动匹配对应的视图文件。
...
/Views
  ...
  /Shared
    ...
    _ViewImports.cshtml
```
- **Index.cshtml**：对应该控制器的默认视图（如 HomeController 的 Index 动作）。
- **Shared 文件夹**：存放可被多个视图复用的共享视图和布局视图（如 _Layout.cshtml）。
- **_ViewStart.cshtml**：用于设置默认的布局文件（用于为同一文件夹中的多个视图指定公共布局视图）。
- **_ViewImports.cshtml**：用于定义命名空间、HTML 帮助器等全局可用的 Razor 语法。
...
Razor 模板的语法主要是 HTML 混合 C# 代码，使用 **@** 符号进行切换。
...
- **@{ ... }**：内联 C# 代码块
- **@using**：引入命名空间
- **@if、@for、@foreach、@for**：条件/循环语句
- **@helper**：定义辅助方法（C# 6 以后不建议使用，可用 Tag Helpers 替代）
- **@section**：定义布局中的内容区块
- **@await**：用于异步调用视图组件或部分视图

![2026-05-25-22-43-04](https://cdn.jsdelivr.net/gh/ankium/mindnotes@assets/bags/2026-05-25-22-43-04.png)

![2026-05-25-22-43-18](https://cdn.jsdelivr.net/gh/ankium/mindnotes@assets/bags/2026-05-25-22-43-18.png)

![2026-05-25-22-43-31](https://cdn.jsdelivr.net/gh/ankium/mindnotes@assets/bags/2026-05-25-22-43-31.png)

![2026-05-25-22-43-47](https://cdn.jsdelivr.net/gh/ankium/mindnotes@assets/bags/2026-05-25-22-43-47.png)

![2026-05-25-22-44-05](https://cdn.jsdelivr.net/gh/ankium/mindnotes@assets/bags/2026-05-25-22-44-05.png)

![2026-05-25-22-44-23](https://cdn.jsdelivr.net/gh/ankium/mindnotes@assets/bags/2026-05-25-22-44-23.png)

![2026-05-25-22-44-47](https://cdn.jsdelivr.net/gh/ankium/mindnotes@assets/bags/2026-05-25-22-44-47.png)

![2026-05-25-22-45-15](https://cdn.jsdelivr.net/gh/ankium/mindnotes@assets/bags/2026-05-25-22-45-15.png)

### 8.2.4 从控制器向视图传递数据的方式

#### 8.2.4.1 ViewData

ViewData 是一个字典对象，在接收请求时会自动创建，并在向客户端发送响应前自动删除。它主要用于将控制器中的数据发送到视图。

![2026-05-25-22-45-34](https://cdn.jsdelivr.net/gh/ankium/mindnotes@assets/bags/2026-05-25-22-45-34.png)

![2026-05-25-22-45-55](https://cdn.jsdelivr.net/gh/ankium/mindnotes@assets/bags/2026-05-25-22-45-55.png)

![2026-05-25-22-46-13](https://cdn.jsdelivr.net/gh/ankium/mindnotes@assets/bags/2026-05-25-22-46-13.png)

通过 ViewData 字典传递数据，是动态的。ViewData 只在当前 Action 中有效，生命周期和 View 相同。
...
是 ViewData 的动态属性封装（使用同一个字典集合），更灵活，但不推荐用于复杂数据。

![2026-05-25-22-47-18](https://cdn.jsdelivr.net/gh/ankium/mindnotes@assets/bags/2026-05-25-22-47-18.png)

![2026-05-25-22-47-30](https://cdn.jsdelivr.net/gh/ankium/mindnotes@assets/bags/2026-05-25-22-47-30.png)

![2026-05-25-22-47-53](https://cdn.jsdelivr.net/gh/ankium/mindnotes@assets/bags/2026-05-25-22-47-53.png)

![2026-05-25-22-48-23](https://cdn.jsdelivr.net/gh/ankium/mindnotes@assets/bags/2026-05-25-22-48-23.png)
...
用于短生命周期的临时数据传递，通常用于页面跳转时的回传数据。TempData  的数据至多只能经过一次Controller传递，并且每个元素至多只能被访问一次，访问以后，自动被删除。

```C#
TempData["Message"] = "Temporary message";
```

#### 8.2.4.5 通过 ViewBag 或 ViewData 的属性进行回传
...
{
    var data = new { Name = "Alice", Age = 28 };
    return View(data);
}
```
...
| 类型                     | 说明                                 | 示例                                            |
| ---------------------- | ---------------------------------- | --------------------------------------------- |
| **页面视图**（Page View）    | 默认视图，用于显示页面内容                      | `Index.cshtml`                                |
| **强类型视图**              | 强类型视图是绑定到指定模型类的视图                  | `PersonModelView.cshtml`                      |
| **共享视图**               | 用于复用部分视图内容，如 `_Partial.cshtml`     | `_Partial.cshtml`                             |
| **布局视图**               | 包含通用结构（如页眉、页脚），其他视图通过 `@layout` 引用 | `_Layout.cshtml`                              |
| **部分视图**（Partial View） | 用于渲染小型模板，通常在页面或布局中嵌入               | `@Html.Partial("_Partial")`                   |
| **视图组件**               | 封装可重用的内容，可独立调用                     | `@await Component.InvokeAsync("MyComponent")` |
...
1. 在强类型视图中，访问模型属性时您仍然可以获得智能感知，因为 **@model** 指令中已经指定了模型类的类型。 

2. 属性名称在编译时进行检查；在强类型视图中，如果属性拼写错误或不存在，会显示错误信息。 

3. 在强类型视图中，每个视图将只对应一个模型。 
...
```C#
// View name is the same name as the current action method.
// 视图名称与当前操作方法的名称相同。
return View();
```
...
```C#
// View name is the same name as the current action method & the view can be a strongly-typed view to receive the supplied model object.
// 视图名称与当前操作方法的名称相同，并且该视图可以是强类型视图以接收提供的模型对象。
return View(object Model);
```
...
```C#
// View name is explicitly specified.
// 视图名称已明确指定。
return View(string ViewName);
```
...
```C#
// View name is explicitly specified & the view can be a strongly-typed view to receive the supplied model object.
...
#### 11.1.1.1 在主程序中使用IConfiguration
...
#### 11.1.1.2 在控制器中使用IConfiguration
...
当你想从ASP.NET Core Web应用程序连接到其他外部RESTful Web服务时，你有一个预定义的类叫做HttpClient。它是System.Net.HTTP命名空间中的一个预定义类，用于向服务器发送HTTP请求并从同一服务器获取响应。这意味着浏览器向服务器发送请求，而运行在服务器上的.NET应用程序充当客户端，它创建HttpClient类的对象，它可以向外部Web服务发送另一个HTTP请求，并最终获取响应。

![2026-06-18-01-12-22](https://cdn.jsdelivr.net/gh/ankium/mindnotes@assets/bags/2026-06-18-01-12-22.png)

### 11.2.1 IHttpClientFactory简介

![2026-06-18-01-14-02](https://cdn.jsdelivr.net/gh/ankium/mindnotes@assets/bags/2026-06-18-01-14-02.png)

IHttpClientFactory是一个接口，它提供一个CreateClient()方法用于创建HttpClient类的实例。它由一个预定义类DefaultHttpClientFactory实现。

使用IHttpClientFactoryr的好处是：我们不必创建自己的HttpClient实例，而是将依赖此IHttpClientFactory的支持，一旦任务完成（读取响应完成），IHttpClientFactory自动负责处理或者关闭与服务器的连接。而如果我们不使用HttpClientFactory，那么必须手动关闭与服务器的连接。

### 11.2.2 HttpClient常见属性和方法

![2026-06-18-01-14-17](https://cdn.jsdelivr.net/gh/ankium/mindnotes@assets/bags/2026-06-18-01-14-17.png)

### 11.2.3 HttpClient示例代码

我们需要将HttpClient服务作为服务集合的一部分添加，然后预定义的HttpClient服务可用并可以在整个应用程序中的任何类中注入。
...
namespace StocksApp.Services
{
 public class FinnhubService : IFinnhubService
 {
  ...
  public async Task<Dictionary<string, object>?> GetStockPriceQuote(string stockSymbol)
  {
   ...
   {
    //Http请求消息HttpRequestMessage
    HttpRequestMessage httpRequestMessage = new HttpRequestMessage() { 
     RequestUri = new Uri($"https://finnhub.io/api/v1/quote?symbol={stockSymbol}&token={_configuration["FinnhubToken"]}"),
     Method = HttpMethod.Get
    };

    //Http响应消息HttpResponseMessage
