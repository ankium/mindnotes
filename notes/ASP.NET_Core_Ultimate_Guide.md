...
![2026-05-14-23-27-30](https://cdn.jsdelivr.net/gh/ankium/mindnotes@assets/bags/2026-05-14-23-27-30.svg)
...
![2026-05-14-23-42-17](https://cdn.jsdelivr.net/gh/ankium/mindnotes@assets/bags/2026-05-14-23-42-17.svg)
...
是 ViewData 的动态属性封装（使用同一个字典集合），更灵活，但不推荐用于复杂数据。ViewBag 是 MVC3 新增语法，ViewBag 不再是字典的键值对结构，而是 dynamic 动态类型，它会在程序运行的时候动态解析。
